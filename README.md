# nvim-treesitter-queries-cairo

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-cairo/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-cairo/actions/workflows/validate.yml)

Neovim tree-sitter queries for **cairo**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-cairo",
...
- [ ] Changes are scoped to `cairo` — do not include files for other languages
